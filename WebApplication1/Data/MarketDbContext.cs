    ...
    public class MarketDbContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>().HasData(
               new Order { Id = 1, ProductId = 1, CustomerId = 1, OrderDate = DateTime.Now },
               new Order { Id = 2, ProductId = 2, CustomerId = 2, OrderDate = DateTime.Now },
               new Order { Id = 3, ProductId = 3, CustomerId = 3, OrderDate = DateTime.Now },
               new Order { Id = 4, ProductId = 4, CustomerId = 4, OrderDate = DateTime.Now },
               new Order { Id = 5, ProductId = 5, CustomerId = 5, OrderDate = DateTime.Now }
           );
